...
class Config:
    ...
    DEV_UI_URL = os.getenv("DEV_UI_URL", "https://www.saucedemo.com")
    STAGING_UI_URL = os.getenv("STAGING_UI_URL", "https://www.saucedemo.com")
    QA_UI_URL = os.getenv("QA_UI_URL", "https://www.saucedemo.com")
    UAT_UI_URL = os.getenv("UAT_UI_URL", "https://www.saucedemo.com")
    PROD_UI_URL = os.getenv("PROD_UI_URL", "https://www.saucedemo.com")
