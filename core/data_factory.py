...
class DataFactory:
    ...
    def generate_date_of_birth(self, minimum_age: int = 18, maximum_age: int = 65) -> str:
        """Generate random date of birth (YYYY-MM-DD)"""
        date = self.fake.date_of_birth(minimum_age=minimum_age, maximum_age=maximum_age)
    ...
    def generate_address(self) -> Dict[str, str]:
        """Generate structured address dictionary"""
        addr = {
        ...
        self._last_generated = addr
        return addr

    def generate_street_address(self) -> str:
        """Generate street address string"""
    ...
    def generate_credit_card_number(self, card_type: Optional[str] = None) -> str:
        ...
        while len(cc) < 13:
            cc = self.fake.credit_card_number(card_type="visa")
        self._last_generated = cc
        return self._last_generated
    
    def generate_credit_card(self) -> str:
        """Alias for generate_credit_card_number"""
        return self.generate_credit_card_number()

    def generate_cvv(self) -> str:
        """Generate random 3-digit CVV"""
        self._last_generated = f"{random.randint(100, 999)}"
        return self._last_generated
    ...
    def generate_currency_code(self) -> str:
        ...
        self._last_generated = random.choice(currencies)
        return self._last_generated
